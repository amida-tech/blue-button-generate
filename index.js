...
var gen = function (data, CCD, xmlDoc, section_name) {
    if (data) {
        if (section_name === "demographics") {
            ...
            js2xml.fillUsingTemplate(xmlDoc, data, sectionLevel.socialHistorySectionEntriesRequired);
        } else if (section_name === "vitals") {
            js2xml.fillUsingTemplate(xmlDoc, data, sectionLevel.vitalsSectionEntriesRequired);
        }
    } else {
        return xmlDoc;
    }
