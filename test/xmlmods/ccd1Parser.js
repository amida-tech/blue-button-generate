module.exports = [{
    ...
    description: "Medications Section (entries required)",
    type: "rootTemplate",
    childxpaths: [{
        xpath: "h:title",
        comment: "titles may differ"
    ...
    description: "Problems Section (entries required)",
    type: "rootTemplate",
    childxpaths: [{
        xpath: "h:title",
        comment: "titles may differ"
    ...
    xpath: "2.16.840.1.113883.10.20.22.2.22.1",
    description: "Encounters Section (entries required)",
    type: "rootTemplate",
    childxpaths: [{
        xpath: "h:title",
        comment: "titles may differ"
    ...
    description: "Procedures Section (entries required)",
    type: "rootTemplate",
    childxpaths: [{
        xpath: "h:title",
        comment: "titles may differ"
    ...
    description: "Plan of Care Section (entries required)",
    type: "rootTemplate",
    childxpaths: [{
        xpath: "h:title",
        comment: "titles may differ"
    ...
    description: "Payers Section (entries required)",
    type: "rootTemplate",
    childxpaths: [{
        xpath: "h:title",
        comment: "titles may differ"
    ...
    description: "Social History Section (entries required)",
    type: "rootTemplate",
    childxpaths: [{
        xpath: "h:title",
        comment: "titles may differ"
